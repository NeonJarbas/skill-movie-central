...
class MovieCentralSkill(OVOSCommonPlaybackSkill):
    def __init__(self, *args, **kwargs):
        ...
        self.skill_icon = join(dirname(__file__), "res", "moviecentral_icon.jpg")
    ...
    def get_playlist(self, score=50, num_entries=25):
        ...
        return {
            ...
            "title": "Movie Central (Movie Playlist)",
            "author": "Movie Central"
        }
...
if __name__ == "__main__":
    ...
    s = MovieCentralSkill(bus=FakeBus(), skill_id="t.fake")
    for r in s.search_db("Killer Mermaid", MediaType.MOVIE):
        print(r)
        # {'title': 'Killer Mermaid | Full Movie | Fantasy Horror | Kristina Klebe', 'author': 'Movie Central', 'match_confidence': 75, 'media_type': <MediaType.MOVIE: 10>, 'uri': 'youtube//https://youtube.com/watch?v=AAC12KUtWp0', 'playback': <PlaybackType.VIDEO: 1>, 'skill_icon': 'https://github.com/OpenVoiceOS/ovos-ocp-audio-plugin/raw/master/ovos_plugin_common_play/ocp/res/ui/images/ocp.png', 'skill_id': 't.fake', 'image': 'https://i.ytimg.com/vi/AAC12KUtWp0/sddefault.jpg', 'bg_image': 'https://i.ytimg.com/vi/AAC12KUtWp0/sddefault.jpg'}
